...
export default function Navbar() {
  ...
  return (
    <nav style={{ padding: "1rem", background: "#f5f5f5", display: "flex", flexWrap: "wrap" }}>
      ...
      <Link href="/terms" style={router.pathname === "/terms" ? activeLinkStyle : linkStyle}>利用規約</Link>
      <Link href="/privacy" style={router.pathname === "/privacy" ? activeLinkStyle : linkStyle}>プライバシー</Link>
    </nav>
  );
}